...
| As a registered user, I want to create a new problem post so I can share workplace issues              | If logged in, users can submit a validated form as a new problem with all relevant field, draft is saved for admin publication                                                             |
